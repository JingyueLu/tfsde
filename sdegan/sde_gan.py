...
class MLP(layers.Layer):
    def __init__(self, out_size, mlp_size, num_layers, tanh, initializer=None):
        ...
        model_layers.append(layers.Dense(out_size))
...
class Generator(keras.Model):
    ...
    def call(self, inputs):
        ...
        # Testing
        import torch
        init_noise = torch.load('/home/jodie/tfsde/tests/torch_model_info/init_noise.pth')
...
def main(
    ...
    for step in trange:
        ...
        averaged_generator.apply_gradients(zip(g_gradients, generators.trainable_variables))
